...
SECRET_KEY = 'django-insecure-o2r7dihh(gu)yryij9k#o+r$s!bv0z@8*r$z9yr2lb2u6+!rwr'
...
CSRF_TRUSTED_ORIGINS = ["localhost", "127.0.0.1", "http://brian-altan-mentalhealthtracker.pbp.cs.ui.ac.id", "https://brian-altan-mentalhealthtracker.pbp.cs.ui.ac.id"]